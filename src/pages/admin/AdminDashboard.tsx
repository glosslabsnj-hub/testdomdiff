        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Card className="bg-charcoal border-border"><CardHeader className="pb-2"><CardTitle className="text-sm text-muted-foreground">Conversion Rate</CardTitle></CardHeader><CardContent><div className="text-3xl font-bold text-primary">{leadsLoading || !leadAnalytics?.totalLeads ? "..." : `${Math.min(100, Math.round(((leadAnalytics?.conversions || 0) / leadAnalytics.totalLeads) * 100))}%`}</div></CardContent></Card>
            </div>
          </TabsContent>
