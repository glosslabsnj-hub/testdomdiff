...
import { Check, Flame, Cross, Users, Target, Dumbbell, BookOpen, Clock, Calendar, Trophy, ArrowRight, ChevronDown } from "lucide-react";
        ...
        <div className="relative z-10 section-container text-center py-20">
          <div className="max-w-4xl mx-auto">
            <h1 className="headline-hero mb-6 animate-fade-in">
              Built Different.<br />
              <span className="text-primary">Led by God.</span>
            </h1>
            ...
            <div>
              ...
              <div className="space-y-6 text-muted-foreground">
                <div className="border-l-2 border-primary pl-4">
                  <p className="text-sm text-primary uppercase tracking-wider mb-1">Before</p>
                  <p>Lost. Undisciplined. Running from purpose. Making every excuse in the book.</p>
                </div>
                <div className="border-l-2 border-primary pl-4">
                  <p className="text-sm text-primary uppercase tracking-wider mb-1">Turning Point</p>
                  <p>Rock bottom became the foundation. God broke me down to build me back up — different.</p>
                </div>
                <div className="border-l-2 border-primary pl-4">
                  <p className="text-sm text-primary uppercase tracking-wider mb-1">Now</p>
        ...
        <div className="section-container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {howItWorks.map((step, index) => (
              ...
              >
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-primary rounded-lg flex items-center justify-center font-display text-xl text-primary-foreground">
                  {step.step}
                </div>
      ...
      <section className="py-20 md:py-32 bg-charcoal">
        <div className="section-container">
          ...
          <div className="relative mb-16 max-w-4xl mx-auto">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-background/60 via-transparent to-background/60 rounded-lg" />
            <div className="absolute bottom-4 left-4 bg-background/80 backdrop-blur px-4 py-2 rounded">
              <p className="text-sm text-primary uppercase tracking-wider">Before → After</p>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-semibold text-primary">{testimonial.transformation}</span>
                </div>
