      ...
      {latestAudit && (
        <div className="space-y-4">
          ...
          {latestAudit.audit_data?.optimized_bio && (
            <div className="rounded-lg bg-charcoal border border-border p-4">
              <h4 className="text-xs font-semibold text-muted-foreground mb-2">Suggested Bio</h4>
              <p className="text-sm font-mono whitespace-pre-wrap bg-background/50 rounded p-3 border border-border">
                {latestAudit.audit_data.optimized_bio}
              </p>
            </div>
          )}
